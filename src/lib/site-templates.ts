...
const RAW_TEMPLATES: Omit<SiteTemplate, "thumb">[] = [
  ...
  // 3) Lãng mạn — pastel hồng, Cormorant serif, bo tròn, dịu dàng.
  {
    ...
    blocks: [
      ...
      { type: "pricing", config: { heading: "Bảng giá", eyebrow: "Các gói dịch vụ", layout: "card", grouping: "tabs" } },
  ...
  // 4) Câu chuyện — nhiếp ảnh gia cá nhân, editorial ấm, bố cục lệch trái.
  {
    ...
    blocks: [
      ...
      { type: "pricing", config: { heading: "Bảng giá", eyebrow: "Chi phí", layout: "compact", grouping: "tabs" } },
  ...
  // 6) Sự kiện — media/event company, nền đen acid-yellow (từ mediadynamic.dc.html).
  {
    ...
    blocks: [
      ...
      { type: "pricing", config: { heading: "Chi phí tham khảo", eyebrow: "Bảng giá", layout: "table", grouping: "tabs" } },
  ...
  // 8) Tối giản — nhiếp ảnh cá nhân, trắng tinh serif (từ photographerminimal.dc.html).
  {
    ...
    blocks: [
      ...
      { type: "pricing", config: { heading: "Bảng giá", eyebrow: "Chi phí", layout: "compact", grouping: "stack" } },
