...
export const WEDDING_SEED: SeedItem[] = [
  ...
  { list_key: "cuoi", category: "Gói chụp cơ bản", name: "Phóng sự x1", price: 3500000, unit: "", description: "1 thợ chụp nhà gái\nGiao toàn bộ file gốc\n150–200 hình chỉnh sửa" },
...
export const ENGAGEMENT_SEED: SeedItem[] = [
  ...
  { list_key: "dinh-hon", category: "Gói quay PS đính hôn", name: "Gói combo", price: 12500000, unit: "", description: "2 thợ chụp, 2 thợ quay, 1 flycam (Sáng → trưa)\nGiao toàn bộ file gốc\nChỉnh sửa 300–400 hình\nVideo 5–7 phút (theo yêu cầu)\nTặng Album 100 ảnh" },
