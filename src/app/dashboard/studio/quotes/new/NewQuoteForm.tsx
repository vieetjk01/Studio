...
export default function NewQuoteForm({ ownerId }: { ownerId: string }) {
  ...
  function add() {
    setItems((arr) => [...arr, { name: "", description: "", qty: 1, unit_price: 0, is_optional: true }]);
  }
    ...
    <div className="space-y-6" data-testid="quote-new-page">
      ...
      <section className="card p-5">
        <div className="flex items-center justify-between">
          ...
          <button onClick={add} className="btn-ghost px-2.5 py-1.5 text-xs" data-testid="quote-item-add"><Plus size={12} /> Thêm hạng mục</button>
        </div>
