...
// Trình tạo website kéo-thả (canvas + inline edit + inspector). Dùng chung
// bảng sites/site_blocks với trình quản lý cũ ở /dashboard/site nên dữ liệu &
// xuất bản hoàn toàn tương thích.
